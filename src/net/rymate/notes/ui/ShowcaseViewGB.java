 ...
 */
public class ShowcaseViewGB extends RelativeLayout implements View.OnClickListener, View.OnTouchListener {
    ...
    protected ShowcaseViewGB(Context context) {
        this(context, null, R.styleable.CustomTheme_showcaseViewStyle);
    }

    protected ShowcaseViewGB(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void moveHand(float offsetStartX, float offsetStartY, float offsetEndX, float offsetEndY, AnimationUtils.AnimationEndListener listener) {
    ...
    public interface OnShowcaseEventListener {
        ...
        public void onShowcaseViewHide(ShowcaseViewGB showcaseView);

        public void onShowcaseViewShow(ShowcaseViewGB showcaseView);
    ...
    /**
     * Quick method to insert a ShowcaseViewGB into an Activity
     *
     ...
     */
    public static ShowcaseViewGB insertShowcaseView(View viewToShowcase, Activity activity, String title,
     ...
     * @return the created ShowcaseViewGB instance
     */
    public static ShowcaseViewGB insertShowcaseView(View viewToShowcase, Activity activity, int title,
    ...
    public static ShowcaseViewGB insertShowcaseView(int showcaseViewId, Activity activity, String title,
                                                  String detailText, ConfigOptions options) {
    ...
    public static ShowcaseViewGB insertShowcaseView(int showcaseViewId, Activity activity, int title,
                                                  int detailText, ConfigOptions options) {
        View v = activity.findViewById(showcaseViewId);
        if (v != null) {
            return insertShowcaseView(v, activity, title, detailText, options);
    ...
    public static ShowcaseViewGB insertShowcaseView(float x, float y, Activity activity, String title,
                                                  String detailText, ConfigOptions options) {
        ShowcaseViewGB sv = new ShowcaseViewGB(activity);
        if (options != null)
            sv.setConfigOptions(options);
    ...
    public static ShowcaseViewGB insertShowcaseView(float x, float y, Activity activity, int title,
                                                  int detailText, ConfigOptions options) {
        ShowcaseViewGB sv = new ShowcaseViewGB(activity);
        if (options != null)
            sv.setConfigOptions(options);
    ...
    public static ShowcaseViewGB insertShowcaseView(View showcase, Activity activity) {
     ...
     * @param type       the type of item to showcase (can be ITEM_ACTION_HOME, ITEM_TITLE_OR_SPINNER, ITEM_ACTION_ITEM or ITEM_ACTION_OVERFLOW)
     * @param itemId     the ID of an Action item to showcase (only required for ITEM_ACTION_ITEM
     * @param activity   Activity to insert the ShowcaseViewGB into
     * @param title      Text to show as a title. Can be null.
     * @param detailText More detailed text. Can be null.
     * @param options    A set of options to customise the ShowcaseViewGB
     * @return the created ShowcaseViewGB instance
    ...
    public static ShowcaseViewGB insertShowcaseView(float x, float y, Activity activity) {
